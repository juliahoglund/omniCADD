...
# https://genome.ucsc.edu/cgi-bin/hgTables group "mapping and sequencing", track "Chromosome Band", table "cytoBand" for ideogram

list.of.packages <- c("ggfittext", "patchwork", "ggplotify", "gridExtra", "BiocManager", "kableExtra", "ape", "ggpubr", "knitr", "gtools", "ggtext")
...
if (params$ideogram == 'None') {
  ...
  sscr_ideoGram <- fread(params$ideogram) %>% 
