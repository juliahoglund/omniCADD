...
params:
  ...
  ingroup: sus scrofa
  outgroup: bos taurus
  path: ~/Documents/GitHub/omniCADD/
---
...
load(paste(params$path, "data/graphsElephant.RData", sep = ""))
...
if (params$ideogram == 'None') {
  ...
  # making the data frame for karyotype visualisation
  blobby2 <- data.frame(chrom = info.fai$chromosome, # keep the factors, one for each chrom
                       pos = info.fai$srcSize,
                       name = info.fai$chromosome,
                       value = info.fai$srcSize,
