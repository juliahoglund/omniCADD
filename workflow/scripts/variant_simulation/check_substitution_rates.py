...
def write_summary(
        log_file, chrom, mut, ACn, AGn, ATn, CAn, CGn, CTn, GAn, GCn, GTn, TAn, TCn, TGn,
        mutCpG, CA, CG, CT, GA, GC, GT
):
...
for file in filenames:
    chrom, mut, ACn, AGn, ATn, CAn, CGn, CTn, GAn, GCn, GTn, TAn, TCn, TGn, mutCpG, CA, CG, CT, GA, GC, GT = (
        process_logfile(file, chrom_list)
    )
    write_summary(
        log_logfiles, chrom, mut, ACn, AGn, ATn, CAn, CGn, CTn, GAn, GCn, GTn, TAn, TCn, TGn,
        mutCpG, CA, CG, CT, GA, GC, GT
    )
