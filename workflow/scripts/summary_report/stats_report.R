...
params:
  ...
  annotation: results/visualisation/CDS.regions.bed
  bedfile: results/visualisation/Ancestor.bed
...
tryCatch({
  load(paste(params$path, "results/visualisation/graphs.RData", sep = ""))
