...
rule all:
        input:
                ...
                expand("results/whole_genome_scores/RAW_scores_chr{chr}.csv",
                        chr=config["chromosomes"]["score"]),
                # 9. final report
                "results/visualisation/final_report.html",
                "results/visualisation/final_report.pdf",
                "results/visualisation/final_report.rst",
                "results/visualisation/final_report.rst.txt",
                "results/visualisation/final_report.rst.html",
                "results/visualisation/final_report.rst.json",
                "results/visualisation/final_report.rst.md",
                "results/visualisation/final_report.rst.xml",
                "results/visualisation/final_report.rst.yaml",
                "results/visualisation/final_report.rst.yml",
                "results/visualisation/final_report.rst.txt.md",